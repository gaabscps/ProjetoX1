    ...
    <div className='d-flex flex-column justify-content-between'>
      ...
      <div className='mb-2'>
        <Select
          name='game'
          value={game}
          placeholder='Jogo para o desafio'
          option={games?.map((game: any) => {
            return {
              value: game.gameId,
              label: game.name,
            }
        ...
        <Input
          ...
          onChange={handleChange}
          type='number'
          placeholder='Duração do convite. Ex: 10'
        />
      ...
      <Textarea
        ...
        onChange={handleChange}
        value={textarea}
        placeholder='Digite uma mensagem para o seu oponente. (opcional) Ex: Bora X1?'
        maxCharacters={60}
        marginBottom='40px'
      />
      <div className='mb-2'>
