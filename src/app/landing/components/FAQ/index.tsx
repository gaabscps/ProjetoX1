...
export default function LandingPageFaq() {
  ...
  const content: Content[] = [
    ...
    },
    {
      ...
      accordionContent:
        'Levamos a segurança muito a sério no PlayX1. Nosso sistema está protegido por um firewall de força industrial. Todos os dados confidenciais são transmitidos por meio de criptografia de alto nível de 256 bits para proteção contra interceptação. Todas as nossas transações financeiras são realizadas pela Rede, líder em sistemas de pagamento online.',
    },
    {
      accordionTitle: 'Custa alguma coisa para se inscrever na playx1.gg?',
      accordionContent:
        'A inscrição na PlayX1 é 100% gratuita e não há cobrança de assinatura mensal.',
    },
    {
    ...
    //   accordionContent:
    //     'A PlayX1 oferece suporte aos seguintes consoles: Xbox One, Xbox Series S e X, PS4 e PS5, PC e Mobile',
    // },
    // {
    //   accordionTitle: 'Quando custa jogar na PlayX1?',
    //   accordionContent:
    //     'Os confrontos diretos possuem um valor mínimo de R$ 5,00 por desafio e contam uma taxa de serviço fixa de 10%. Todos as disputas online de consoles, PC e mobile têm entradas e prêmios definidos. As taxas de serviço ajudam o site a funcionar sem problemas e oferecem toda segurança necessária para o seu dinheiro',
    // },
    // {
    //   accordionTitle: 'Custa alguma coisa para se inscrever na playx1.gg?',
    //   accordionContent:
